...
1. "company": List of company names (e.g., ["Infosys", "Dr. Reddy's", "NTPC"]). Use null if not mentioned.
2. "sector": List of sectors (e.g., ["IT", "Banking", "Energy", "Pharma"]). Use null if not mentioned.
3. "fundamental": The financial metric requested (e.g., "sales", "net profit", "roe", "stock price", "eps", "debt equity" etc.). Use null if not mentioned.
4. "time_period": Time period string (e.g., "2019", "2024-2020", "2024-2015"). Use null if not mentioned. The current year is 2024. If the query asks for "last 5 years", use "2024-2020", and so on.
